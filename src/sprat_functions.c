...
/************************************************************************
 ...
 Required By:		sprat_red_findedges.c
 Additional Notes:	
...
/************************************************************************
 ...
 Purpose:		finds the coefficients of the [order] fit, for
			...
			[chi_squared]
 Required By:		sprat_red_arcfit.c
 Additional Notes:
...
/************************************************************************
 ...
 Required By:		sprat_red_trace.c
			sprat_red_extract_simple.c
			sprat_red_arcfit.c
			sprat_red_rebin.c
			sprat_red_reformat.c
...
/************************************************************************
 ...
 Required By:		sprat_red_reformat.c
 Additional Notes:	None
...
/************************************************************************
 ...
 Required By:		sprat_red_extract.c
 Additional Notes:	None
...
/************************************************************************
 ...
 Required By:		sprat_red_extract_simple.c
			sprat_red_arcfit.c
			sprat_red_rebin.c
			sprat_red_subsky.c
			sprat_red_reformat.c
...
/************************************************************************
 ...
 Required By:           sprat_red_extract_simple.c
			sprat_red_arcfit.c
			sprat_red_correct_throughput.c
			sprat_red_rebin.c
			sprat_red_subsky.c
			sprat_red_reformat.c
 Additional Notes:      None
