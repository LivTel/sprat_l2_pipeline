...
def execute(f_in,
    ...
    if not isinstance(data[0],
                      np.ndarray):  # this occurs if the hdu contains no data..
        ax = plt.gca()
    ...
    if telluric:
        coords_to_annote = [(7623.325, 0.95 * y_max), (7186.487, 0.95 * y_max),
                            (6874.286, 0.95 * y_max), (6281.727, 0.95 * y_max)]
